...
export default function ShirtsPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-12 text-black">
            <h1 className="text-5xl font-bold mb-4 text-gray-900 mt-30 bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent text-center">{categoryTitles.shirts}</h1>
            <p className="text-gray-600 mb-12 text-lg text-center">Showcasing {items.length} custom designs</p>
